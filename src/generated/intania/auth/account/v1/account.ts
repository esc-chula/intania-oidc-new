...
export const StudentLoginRequest: MessageFns<StudentLoginRequest> = {
  encode(message: StudentLoginRequest, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    if (message.username !== "") {
  ...
  decode(input: BinaryReader | Uint8Array, length?: number): StudentLoginRequest {
  ...
  fromJSON(object: any): StudentLoginRequest {
    return {
      ...
      verifyWithLdap: isSet(object.verifyWithLdap) ? globalThis.Boolean(object.verifyWithLdap) : false,
    };
  },
  ...
  create<I extends Exact<DeepPartial<StudentLoginRequest>, I>>(base?: I): StudentLoginRequest {
    return StudentLoginRequest.fromPartial(base ?? ({} as any));
  },
  fromPartial<I extends Exact<DeepPartial<StudentLoginRequest>, I>>(object: I): StudentLoginRequest {
    const message = createBaseStudentLoginRequest();
...
function createBaseStudentLoginResponse(): StudentLoginResponse {
  return { session: undefined, student: undefined };
}

export const StudentLoginResponse: MessageFns<StudentLoginResponse> = {
  encode(message: StudentLoginResponse, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
  ...
  decode(input: BinaryReader | Uint8Array, length?: number): StudentLoginResponse {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    let end = length === undefined ? reader.len : reader.pos + length;
  ...
  create<I extends Exact<DeepPartial<StudentLoginResponse>, I>>(base?: I): StudentLoginResponse {
    return StudentLoginResponse.fromPartial(base ?? ({} as any));
  },
  fromPartial<I extends Exact<DeepPartial<StudentLoginResponse>, I>>(object: I): StudentLoginResponse {
    const message = createBaseStudentLoginResponse();
...
export const IntrospectSessionRequest: MessageFns<IntrospectSessionRequest> = {
  encode(message: IntrospectSessionRequest, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    if (message.sessionId !== "") {
      writer.uint32(10).string(message.sessionId);
    }
    return writer;
  ...
  decode(input: BinaryReader | Uint8Array, length?: number): IntrospectSessionRequest {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    let end = length === undefined ? reader.len : reader.pos + length;
  ...
  create<I extends Exact<DeepPartial<IntrospectSessionRequest>, I>>(base?: I): IntrospectSessionRequest {
    return IntrospectSessionRequest.fromPartial(base ?? ({} as any));
  },
  fromPartial<I extends Exact<DeepPartial<IntrospectSessionRequest>, I>>(object: I): IntrospectSessionRequest {
    const message = createBaseIntrospectSessionRequest();
    message.sessionId = object.sessionId ?? "";
    return message;
  },
...
export const IntrospectSessionResponse: MessageFns<IntrospectSessionResponse> = {
  encode(message: IntrospectSessionResponse, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    if (message.session !== undefined) {
      Session.encode(message.session, writer.uint32(10).fork()).join();
    }
    return writer;
  ...
  decode(input: BinaryReader | Uint8Array, length?: number): IntrospectSessionResponse {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    let end = length === undefined ? reader.len : reader.pos + length;
  ...
  create<I extends Exact<DeepPartial<IntrospectSessionResponse>, I>>(base?: I): IntrospectSessionResponse {
    return IntrospectSessionResponse.fromPartial(base ?? ({} as any));
  },
  fromPartial<I extends Exact<DeepPartial<IntrospectSessionResponse>, I>>(object: I): IntrospectSessionResponse {
    const message = createBaseIntrospectSessionResponse();
    message.session = (object.session !== undefined && object.session !== null)
      ? Session.fromPartial(object.session)
      : undefined;
...
function createBaseSession(): Session {
  return { id: "", accountType: 0, accountId: 0, expiresAt: undefined };
}
...
export const AccountServiceService = {
  studentLogin: {
    ...
    requestSerialize: (value: StudentLoginRequest) => Buffer.from(StudentLoginRequest.encode(value).finish()),
    requestDeserialize: (value: Buffer) => StudentLoginRequest.decode(value),
    responseSerialize: (value: StudentLoginResponse) => Buffer.from(StudentLoginResponse.encode(value).finish()),
  ...
  me: {
    ...
    requestStream: false,
    responseStream: false,
    requestSerialize: (value: MeRequest) => Buffer.from(MeRequest.encode(value).finish()),
    requestDeserialize: (value: Buffer) => MeRequest.decode(value),
    responseSerialize: (value: MeResponse) => Buffer.from(MeResponse.encode(value).finish()),
  ...
  introspectSession: {
    ...
    requestStream: false,
    responseStream: false,
    requestSerialize: (value: IntrospectSessionRequest) => Buffer.from(IntrospectSessionRequest.encode(value).finish()),
    requestDeserialize: (value: Buffer) => IntrospectSessionRequest.decode(value),
    responseSerialize: (value: IntrospectSessionResponse) =>
      Buffer.from(IntrospectSessionResponse.encode(value).finish()),
    responseDeserialize: (value: Buffer) => IntrospectSessionResponse.decode(value),
  },
} as const;
...
export interface AccountServiceServer extends UntypedServiceImplementation {
  ...
  /** Used to retrieve information about session without the user information. */
  introspectSession: handleUnaryCall<IntrospectSessionRequest, IntrospectSessionResponse>;
}

export interface AccountServiceClient extends Client {
  studentLogin(
    request: StudentLoginRequest,
    callback: (error: ServiceError | null, response: StudentLoginResponse) => void,
  ): ClientUnaryCall;
  studentLogin(
    request: StudentLoginRequest,
    metadata: Metadata,
  ...
  introspectSession(
    ...
    callback: (error: ServiceError | null, response: IntrospectSessionResponse) => void,
  ): ClientUnaryCall;
  introspectSession(
    request: IntrospectSessionRequest,
    metadata: Metadata,
