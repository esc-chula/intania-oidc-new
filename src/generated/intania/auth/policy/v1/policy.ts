...
export const GetPolicyRequest: MessageFns<GetPolicyRequest> = {
    ...
    create<I extends Exact<DeepPartial<GetPolicyRequest>, I>>(
        base?: I,
    ): GetPolicyRequest {
...
export const GetPolicyResponse: MessageFns<GetPolicyResponse> = {
    ...
    create<I extends Exact<DeepPartial<GetPolicyResponse>, I>>(
        base?: I,
    ): GetPolicyResponse {
...
export const ListPolicyRequest: MessageFns<ListPolicyRequest> = {
    ...
    create<I extends Exact<DeepPartial<ListPolicyRequest>, I>>(
        base?: I,
    ): ListPolicyRequest {
        return ListPolicyRequest.fromPartial(base ?? ({} as any));
    },
    fromPartial<I extends Exact<DeepPartial<ListPolicyRequest>, I>>(
        _: I,
    ): ListPolicyRequest {
        const message = createBaseListPolicyRequest();
        return message;
...
export const ListPolicyResponse: MessageFns<ListPolicyResponse> = {
            ...
            switch (tag >>> 3) {
                case 1: {
                    ...
                    message.policies.push(
                        Policy.decode(reader, reader.uint32()),
                    );
                    continue;
                }
            }
    ...
    create<I extends Exact<DeepPartial<ListPolicyResponse>, I>>(
        base?: I,
    ): ListPolicyResponse {
        return ListPolicyResponse.fromPartial(base ?? ({} as any));
    },
    fromPartial<I extends Exact<DeepPartial<ListPolicyResponse>, I>>(
        object: I,
    ): ListPolicyResponse {
        const message = createBaseListPolicyResponse();
        message.policies =
            object.policies?.map((e) => Policy.fromPartial(e)) || [];
        return message;
    },
};
...
export const EditPolicyRequest: MessageFns<EditPolicyRequest> = {
    ...
    create<I extends Exact<DeepPartial<EditPolicyRequest>, I>>(
        base?: I,
    ): EditPolicyRequest {
        return EditPolicyRequest.fromPartial(base ?? ({} as any));
    },
    fromPartial<I extends Exact<DeepPartial<EditPolicyRequest>, I>>(
        object: I,
    ): EditPolicyRequest {
        const message = createBaseEditPolicyRequest();
        message.id = object.id ?? "";
...
export const EditPolicyResponse: MessageFns<EditPolicyResponse> = {
    ...
    create<I extends Exact<DeepPartial<EditPolicyResponse>, I>>(
        base?: I,
    ): EditPolicyResponse {
        return EditPolicyResponse.fromPartial(base ?? ({} as any));
    },
    fromPartial<I extends Exact<DeepPartial<EditPolicyResponse>, I>>(
        _: I,
    ): EditPolicyResponse {
        const message = createBaseEditPolicyResponse();
        return message;
...
export const AttachPolicyRequest: MessageFns<AttachPolicyRequest> = {
    ...
    create<I extends Exact<DeepPartial<AttachPolicyRequest>, I>>(
        base?: I,
    ): AttachPolicyRequest {
        return AttachPolicyRequest.fromPartial(base ?? ({} as any));
    },
    fromPartial<I extends Exact<DeepPartial<AttachPolicyRequest>, I>>(
        object: I,
    ): AttachPolicyRequest {
        const message = createBaseAttachPolicyRequest();
...
export const AttachPolicyResponse: MessageFns<AttachPolicyResponse> = {
    ...
    create<I extends Exact<DeepPartial<AttachPolicyResponse>, I>>(
        base?: I,
    ): AttachPolicyResponse {
        return AttachPolicyResponse.fromPartial(base ?? ({} as any));
    },
    fromPartial<I extends Exact<DeepPartial<AttachPolicyResponse>, I>>(
        _: I,
    ): AttachPolicyResponse {
        const message = createBaseAttachPolicyResponse();
        return message;
...
export const PolicyServiceService = {
    ...
    listPolicy: {
        ...
        requestStream: false,
        responseStream: false,
        requestSerialize: (value: ListPolicyRequest) =>
            Buffer.from(ListPolicyRequest.encode(value).finish()),
        requestDeserialize: (value: Buffer) => ListPolicyRequest.decode(value),
        responseSerialize: (value: ListPolicyResponse) =>
            Buffer.from(ListPolicyResponse.encode(value).finish()),
        responseDeserialize: (value: Buffer) =>
            ListPolicyResponse.decode(value),
    },
    editPolicy: {
        path: "/intania.auth.policy.v1.PolicyService/EditPolicy",
        requestStream: false,
        responseStream: false,
        requestSerialize: (value: EditPolicyRequest) =>
            Buffer.from(EditPolicyRequest.encode(value).finish()),
        requestDeserialize: (value: Buffer) => EditPolicyRequest.decode(value),
        responseSerialize: (value: EditPolicyResponse) =>
            Buffer.from(EditPolicyResponse.encode(value).finish()),
        responseDeserialize: (value: Buffer) =>
            EditPolicyResponse.decode(value),
    },
    attachPolicy: {
        path: "/intania.auth.policy.v1.PolicyService/AttachPolicy",
        requestStream: false,
        responseStream: false,
        requestSerialize: (value: AttachPolicyRequest) =>
            Buffer.from(AttachPolicyRequest.encode(value).finish()),
        requestDeserialize: (value: Buffer) =>
            AttachPolicyRequest.decode(value),
        responseSerialize: (value: AttachPolicyResponse) =>
            Buffer.from(AttachPolicyResponse.encode(value).finish()),
        responseDeserialize: (value: Buffer) =>
            AttachPolicyResponse.decode(value),
    },
} as const;
