...
export const GetStudentByStudentIdRequest: MessageFns<GetStudentByStudentIdRequest> = {
  encode(message: GetStudentByStudentIdRequest, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
  ...
  decode(input: BinaryReader | Uint8Array, length?: number): GetStudentByStudentIdRequest {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    let end = length === undefined ? reader.len : reader.pos + length;
  ...
  create<I extends Exact<DeepPartial<GetStudentByStudentIdRequest>, I>>(base?: I): GetStudentByStudentIdRequest {
    return GetStudentByStudentIdRequest.fromPartial(base ?? ({} as any));
  },
  fromPartial<I extends Exact<DeepPartial<GetStudentByStudentIdRequest>, I>>(object: I): GetStudentByStudentIdRequest {
    const message = createBaseGetStudentByStudentIdRequest();
...
export const GetStudentByStudentIdResponse: MessageFns<GetStudentByStudentIdResponse> = {
  encode(message: GetStudentByStudentIdResponse, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    if (message.student !== undefined) {
      Student.encode(message.student, writer.uint32(10).fork()).join();
    }
    return writer;
  ...
  decode(input: BinaryReader | Uint8Array, length?: number): GetStudentByStudentIdResponse {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    let end = length === undefined ? reader.len : reader.pos + length;
  ...
  create<I extends Exact<DeepPartial<GetStudentByStudentIdResponse>, I>>(base?: I): GetStudentByStudentIdResponse {
...
export const EditStudentRequest: MessageFns<EditStudentRequest> = {
  encode(message: EditStudentRequest, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    if (message.student !== undefined) {
      Student.encode(message.student, writer.uint32(10).fork()).join();
    }
    if (message.masks !== undefined) {
  ...
  decode(input: BinaryReader | Uint8Array, length?: number): EditStudentRequest {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    let end = length === undefined ? reader.len : reader.pos + length;
  ...
  create<I extends Exact<DeepPartial<EditStudentRequest>, I>>(base?: I): EditStudentRequest {
    return EditStudentRequest.fromPartial(base ?? ({} as any));
  },
  fromPartial<I extends Exact<DeepPartial<EditStudentRequest>, I>>(object: I): EditStudentRequest {
    const message = createBaseEditStudentRequest();
    message.student = (object.student !== undefined && object.student !== null)
      ? Student.fromPartial(object.student)
      : undefined;
...
export const EditStudentResponse: MessageFns<EditStudentResponse> = {
  encode(_: EditStudentResponse, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    return writer;
  },

  decode(input: BinaryReader | Uint8Array, length?: number): EditStudentResponse {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    let end = length === undefined ? reader.len : reader.pos + length;
  ...
  create<I extends Exact<DeepPartial<EditStudentResponse>, I>>(base?: I): EditStudentResponse {
    return EditStudentResponse.fromPartial(base ?? ({} as any));
  },
  fromPartial<I extends Exact<DeepPartial<EditStudentResponse>, I>>(_: I): EditStudentResponse {
    const message = createBaseEditStudentResponse();
    return message;
  },
};
...
export const ListStudentMappingRequest: MessageFns<ListStudentMappingRequest> = {
  encode(message: ListStudentMappingRequest, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    if (message.masks !== undefined) {
      FieldMask.encode(FieldMask.wrap(message.masks), writer.uint32(10).fork()).join();
    }
  ...
  decode(input: BinaryReader | Uint8Array, length?: number): ListStudentMappingRequest {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    let end = length === undefined ? reader.len : reader.pos + length;
  ...
  fromJSON(object: any): ListStudentMappingRequest {
    return {
      masks: isSet(object.masks) ? FieldMask.unwrap(FieldMask.fromJSON(object.masks)) : undefined,
      revalidateCache: isSet(object.revalidateCache) ? globalThis.Boolean(object.revalidateCache) : undefined,
    };
  },
  ...
  create<I extends Exact<DeepPartial<ListStudentMappingRequest>, I>>(base?: I): ListStudentMappingRequest {
    return ListStudentMappingRequest.fromPartial(base ?? ({} as any));
  },
  fromPartial<I extends Exact<DeepPartial<ListStudentMappingRequest>, I>>(object: I): ListStudentMappingRequest {
    const message = createBaseListStudentMappingRequest();
    message.masks = object.masks ?? undefined;
...
export const ListStudentMappingResponse: MessageFns<ListStudentMappingResponse> = {
  encode(message: ListStudentMappingResponse, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
  ...
  decode(input: BinaryReader | Uint8Array, length?: number): ListStudentMappingResponse {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    let end = length === undefined ? reader.len : reader.pos + length;
    ...
    while (reader.pos < end) {
      ...
      switch (tag >>> 3) {
        ...
        case 3: {
          ...
          message.familyStatuses.push(FamilyStatus.decode(reader, reader.uint32()));
          continue;
        }
        case 4: {
          if (tag !== 34) {
          ...
          message.familyMemberStatuses.push(FamilyMemberStatus.decode(reader, reader.uint32()));
          continue;
        }
        case 5: {
          if (tag !== 42) {
  ...
  fromJSON(object: any): ListStudentMappingResponse {
    return {
      ...
      familyStatuses: globalThis.Array.isArray(object?.familyStatuses)
        ...
        : [],
      familyMemberStatuses: globalThis.Array.isArray(object?.familyMemberStatuses)
        ? object.familyMemberStatuses.map((e: any) => FamilyMemberStatus.fromJSON(e))
        : [],
  ...
  toJSON(message: ListStudentMappingResponse): unknown {
    ...
    if (message.familyStatuses?.length) {
      obj.familyStatuses = message.familyStatuses.map((e) => FamilyStatus.toJSON(e));
    }
    if (message.familyMemberStatuses?.length) {
      obj.familyMemberStatuses = message.familyMemberStatuses.map((e) => FamilyMemberStatus.toJSON(e));
    }
  ...
  create<I extends Exact<DeepPartial<ListStudentMappingResponse>, I>>(base?: I): ListStudentMappingResponse {
    return ListStudentMappingResponse.fromPartial(base ?? ({} as any));
  },
  fromPartial<I extends Exact<DeepPartial<ListStudentMappingResponse>, I>>(object: I): ListStudentMappingResponse {
    const message = createBaseListStudentMappingResponse();
    message.departments = object.departments?.map((e) => Department.fromPartial(e)) || [];
    message.religions = object.religions?.map((e) => Religion.fromPartial(e)) || [];
    message.familyStatuses = object.familyStatuses?.map((e) => FamilyStatus.fromPartial(e)) || [];
    message.familyMemberStatuses = object.familyMemberStatuses?.map((e) => FamilyMemberStatus.fromPartial(e)) || [];
...
export const Student: MessageFns<Student> = {
  encode(message: Student, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    ...
    if (message.birthDate !== undefined) {
      Timestamp.encode(toTimestamp(message.birthDate), writer.uint32(162).fork()).join();
    }
    ...
    if (message.familyStatus !== undefined) {
      FamilyStatus.encode(message.familyStatus, writer.uint32(282).fork()).join();
    }
    ...
    if (message.fatherStatus !== undefined) {
      FamilyMemberStatus.encode(message.fatherStatus, writer.uint32(346).fork()).join();
    }
    ...
    if (message.motherStatus !== undefined) {
      FamilyMemberStatus.encode(message.motherStatus, writer.uint32(370).fork()).join();
    }
    ...
    if (message.currentAddressProvince !== undefined) {
      Province.encode(message.currentAddressProvince, writer.uint32(386).fork()).join();
    }
    if (message.currentAddressDistrict !== undefined) {
      District.encode(message.currentAddressDistrict, writer.uint32(394).fork()).join();
    }
    ...
    if (message.hometownAddressProvince !== undefined) {
      Province.encode(message.hometownAddressProvince, writer.uint32(434).fork()).join();
    }
    if (message.hometownAddressDistrict !== undefined) {
      District.encode(message.hometownAddressDistrict, writer.uint32(442).fork()).join();
    }
    ...
    while (reader.pos < end) {
      ...
      switch (tag >>> 3) {
        ...
        case 43: {
          ...
          message.fatherStatus = FamilyMemberStatus.decode(reader, reader.uint32());
          continue;
        }
        case 44: {
          if (tag !== 354) {
        ...
        case 46: {
          ...
          message.motherStatus = FamilyMemberStatus.decode(reader, reader.uint32());
          continue;
        }
        case 47: {
          if (tag !== 378) {
        ...
        case 48: {
          ...
          message.currentAddressProvince = Province.decode(reader, reader.uint32());
          continue;
        }
        case 49: {
          if (tag !== 394) {
          ...
          message.currentAddressDistrict = District.decode(reader, reader.uint32());
          continue;
        }
        case 50: {
          if (tag !== 405) {
        ...
        case 54: {
          ...
          message.hometownAddressProvince = Province.decode(reader, reader.uint32());
          continue;
        }
        case 55: {
          if (tag !== 442) {
          ...
          message.hometownAddressDistrict = District.decode(reader, reader.uint32());
          continue;
        }
        case 56: {
          if (tag !== 453) {
  ...
  fromJSON(object: any): Student {
    return {
      ...
      profilePictureKey: isSet(object.profilePictureKey) ? globalThis.String(object.profilePictureKey) : undefined,
      studentId: isSet(object.studentId) ? globalThis.String(object.studentId) : undefined,
      department: isSet(object.department) ? Department.fromJSON(object.department) : undefined,
      titleTh: isSet(object.titleTh) ? globalThis.String(object.titleTh) : undefined,
      titleEn: isSet(object.titleEn) ? globalThis.String(object.titleEn) : undefined,
      firstNameTh: isSet(object.firstNameTh) ? globalThis.String(object.firstNameTh) : undefined,
      firstNameEn: isSet(object.firstNameEn) ? globalThis.String(object.firstNameEn) : undefined,
      familyNameTh: isSet(object.familyNameTh) ? globalThis.String(object.familyNameTh) : undefined,
      familyNameEn: isSet(object.familyNameEn) ? globalThis.String(object.familyNameEn) : undefined,
      middleNameTh: isSet(object.middleNameTh) ? globalThis.String(object.middleNameTh) : undefined,
      middleNameEn: isSet(object.middleNameEn) ? globalThis.String(object.middleNameEn) : undefined,
      nicknameTh: isSet(object.nicknameTh) ? globalThis.String(object.nicknameTh) : undefined,
      nicknameEn: isSet(object.nicknameEn) ? globalThis.String(object.nicknameEn) : undefined,
      preferredPronoun: isSet(object.preferredPronoun) ? globalThis.String(object.preferredPronoun) : undefined,
      nationalId: isSet(object.nationalId) ? globalThis.String(object.nationalId) : undefined,
      nationality: isSet(object.nationality) ? Country.fromJSON(object.nationality) : undefined,
      birthDate: isSet(object.birthDate) ? fromJsonTimestamp(object.birthDate) : undefined,
      religion: isSet(object.religion) ? Religion.fromJSON(object.religion) : undefined,
      bloodType: isSet(object.bloodType) ? globalThis.String(object.bloodType) : undefined,
      foodLimitations: isSet(object.foodLimitations) ? globalThis.String(object.foodLimitations) : undefined,
      drugAllergies: isSet(object.drugAllergies) ? globalThis.String(object.drugAllergies) : undefined,
      medicalConditions: isSet(object.medicalConditions) ? globalThis.String(object.medicalConditions) : undefined,
      medications: isSet(object.medications) ? globalThis.String(object.medications) : undefined,
      shirtSize: isSet(object.shirtSize) ? globalThis.Number(object.shirtSize) : undefined,
      ...
      phoneNumberVerified: isSet(object.phoneNumberVerified)
        ...
        : undefined,
      lineId: isSet(object.lineId) ? globalThis.String(object.lineId) : undefined,
      ...
      familyStatus: isSet(object.familyStatus) ? FamilyStatus.fromJSON(object.familyStatus) : undefined,
      parent: isSet(object.parent) ? globalThis.String(object.parent) : undefined,
      siblingTotal: isSet(object.siblingTotal) ? globalThis.Number(object.siblingTotal) : undefined,
      siblingOrder: isSet(object.siblingOrder) ? globalThis.Number(object.siblingOrder) : undefined,
      parentPhoneNumber: isSet(object.parentPhoneNumber) ? globalThis.String(object.parentPhoneNumber) : undefined,
      parentAddress: isSet(object.parentAddress) ? globalThis.String(object.parentAddress) : undefined,
      fatherName: isSet(object.fatherName) ? globalThis.String(object.fatherName) : undefined,
      fatherBirthYear: isSet(object.fatherBirthYear) ? globalThis.Number(object.fatherBirthYear) : undefined,
      fatherStatus: isSet(object.fatherStatus) ? FamilyMemberStatus.fromJSON(object.fatherStatus) : undefined,
      motherName: isSet(object.motherName) ? globalThis.String(object.motherName) : undefined,
      motherBirthYear: isSet(object.motherBirthYear) ? globalThis.Number(object.motherBirthYear) : undefined,
      motherStatus: isSet(object.motherStatus) ? FamilyMemberStatus.fromJSON(object.motherStatus) : undefined,
  ...
  toJSON(message: Student): unknown {
    ...
    if (message.currentAddressProvince !== undefined) {
      obj.currentAddressProvince = Province.toJSON(message.currentAddressProvince);
    }
    if (message.currentAddressDistrict !== undefined) {
      obj.currentAddressDistrict = District.toJSON(message.currentAddressDistrict);
    }
    if (message.currentAddressLatitude !== undefined) {
    ...
    if (message.hometownAddressProvince !== undefined) {
      obj.hometownAddressProvince = Province.toJSON(message.hometownAddressProvince);
    }
    if (message.hometownAddressDistrict !== undefined) {
      obj.hometownAddressDistrict = District.toJSON(message.hometownAddressDistrict);
    }
    if (message.hometownAddressLatitude !== undefined) {
  ...
  fromPartial<I extends Exact<DeepPartial<Student>, I>>(object: I): Student {
    ...
    message.nationality = (object.nationality !== undefined && object.nationality !== null)
    ...
    message.familyStatus = (object.familyStatus !== undefined && object.familyStatus !== null)
    ...
    message.fatherStatus = (object.fatherStatus !== undefined && object.fatherStatus !== null)
    ...
    message.motherStatus = (object.motherStatus !== undefined && object.motherStatus !== null)
    ...
    message.currentAddressProvince =
      (object.currentAddressProvince !== undefined && object.currentAddressProvince !== null)
        ? Province.fromPartial(object.currentAddressProvince)
        : undefined;
    message.currentAddressDistrict =
      (object.currentAddressDistrict !== undefined && object.currentAddressDistrict !== null)
        ? District.fromPartial(object.currentAddressDistrict)
        : undefined;
    message.currentAddressLatitude = object.currentAddressLatitude ?? undefined;
    message.currentAddressLongitude = object.currentAddressLongitude ?? undefined;
    ...
    message.hometownAddressProvince =
      (object.hometownAddressProvince !== undefined && object.hometownAddressProvince !== null)
        ? Province.fromPartial(object.hometownAddressProvince)
        : undefined;
    message.hometownAddressDistrict =
      (object.hometownAddressDistrict !== undefined && object.hometownAddressDistrict !== null)
        ? District.fromPartial(object.hometownAddressDistrict)
        : undefined;
    message.hometownAddressLatitude = object.hometownAddressLatitude ?? undefined;
    message.hometownAddressLongitude = object.hometownAddressLongitude ?? undefined;
    message.hometownAddressOther = object.hometownAddressOther ?? undefined;
    message.cueaDataTransferAgreement = object.cueaDataTransferAgreement ?? undefined;
    return message;
  },
};

function createBaseDepartment(): Department {
  return { id: 0, createdAt: undefined, updatedAt: undefined, nameTh: undefined, nameEn: undefined, code: undefined };
}
...
export const Department: MessageFns<Department> = {
  ...
  fromJSON(object: any): Department {
    return {
      ...
      createdAt: isSet(object.createdAt) ? fromJsonTimestamp(object.createdAt) : undefined,
      updatedAt: isSet(object.updatedAt) ? fromJsonTimestamp(object.updatedAt) : undefined,
      nameTh: isSet(object.nameTh) ? globalThis.String(object.nameTh) : undefined,
      nameEn: isSet(object.nameEn) ? globalThis.String(object.nameEn) : undefined,
  ...
  fromPartial<I extends Exact<DeepPartial<Department>, I>>(object: I): Department {
    const message = createBaseDepartment();
    message.id = object.id ?? 0;
    message.createdAt = object.createdAt ?? undefined;
    message.updatedAt = object.updatedAt ?? undefined;
...
function createBaseCountry(): Country {
  return { id: 0, createdAt: undefined, updatedAt: undefined, name: undefined, code: undefined };
}
...
function createBaseReligion(): Religion {
  return { id: 0, createdAt: undefined, updatedAt: undefined, nameTh: undefined, nameEn: undefined };
}
...
function createBaseFamilyStatus(): FamilyStatus {
  return { id: 0, createdAt: undefined, updatedAt: undefined, valueTh: undefined, valueEn: undefined };
}

export const FamilyStatus: MessageFns<FamilyStatus> = {
  encode(message: FamilyStatus, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    if (message.id !== 0) {
      writer.uint32(8).int32(message.id);
    }
    if (message.createdAt !== undefined) {
  ...
  fromJSON(object: any): FamilyStatus {
    return {
      ...
      createdAt: isSet(object.createdAt) ? fromJsonTimestamp(object.createdAt) : undefined,
      updatedAt: isSet(object.updatedAt) ? fromJsonTimestamp(object.updatedAt) : undefined,
      valueTh: isSet(object.valueTh) ? globalThis.String(object.valueTh) : undefined,
      valueEn: isSet(object.valueEn) ? globalThis.String(object.valueEn) : undefined,
    };
  },
  ...
  create<I extends Exact<DeepPartial<FamilyStatus>, I>>(base?: I): FamilyStatus {
    return FamilyStatus.fromPartial(base ?? ({} as any));
  },
  fromPartial<I extends Exact<DeepPartial<FamilyStatus>, I>>(object: I): FamilyStatus {
    const message = createBaseFamilyStatus();
    message.id = object.id ?? 0;
    message.createdAt = object.createdAt ?? undefined;
    message.updatedAt = object.updatedAt ?? undefined;
...
export const FamilyMemberStatus: MessageFns<FamilyMemberStatus> = {
  encode(message: FamilyMemberStatus, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    if (message.id !== 0) {
      writer.uint32(8).int32(message.id);
    }
    if (message.createdAt !== undefined) {
  ...
  decode(input: BinaryReader | Uint8Array, length?: number): FamilyMemberStatus {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    let end = length === undefined ? reader.len : reader.pos + length;
  ...
  create<I extends Exact<DeepPartial<FamilyMemberStatus>, I>>(base?: I): FamilyMemberStatus {
    return FamilyMemberStatus.fromPartial(base ?? ({} as any));
  },
  fromPartial<I extends Exact<DeepPartial<FamilyMemberStatus>, I>>(object: I): FamilyMemberStatus {
    const message = createBaseFamilyMemberStatus();
    message.id = object.id ?? 0;
    message.createdAt = object.createdAt ?? undefined;
    message.updatedAt = object.updatedAt ?? undefined;
...
export const Province: MessageFns<Province> = {
  ...
  fromJSON(object: any): Province {
    return {
      ...
      nameTh: isSet(object.nameTh) ? globalThis.String(object.nameTh) : undefined,
      nameEn: isSet(object.nameEn) ? globalThis.String(object.nameEn) : undefined,
      provinceCode: isSet(object.provinceCode) ? globalThis.Number(object.provinceCode) : undefined,
    };
  },
...
export const District: MessageFns<District> = {
  ...
  fromJSON(object: any): District {
    return {
      ...
      nameEn: isSet(object.nameEn) ? globalThis.String(object.nameEn) : undefined,
      provinceCode: isSet(object.provinceCode) ? globalThis.Number(object.provinceCode) : undefined,
      districtCode: isSet(object.districtCode) ? globalThis.Number(object.districtCode) : undefined,
      postalCode: isSet(object.postalCode) ? globalThis.Number(object.postalCode) : undefined,
    };
  },
...
export const StudentServiceService = {
  getStudentById: {
    ...
    requestSerialize: (value: GetStudentByIdRequest) => Buffer.from(GetStudentByIdRequest.encode(value).finish()),
    requestDeserialize: (value: Buffer) => GetStudentByIdRequest.decode(value),
    responseSerialize: (value: GetStudentByIdResponse) => Buffer.from(GetStudentByIdResponse.encode(value).finish()),
    responseDeserialize: (value: Buffer) => GetStudentByIdResponse.decode(value),
  },
  getStudentByStudentId: {
    ...
    requestDeserialize: (value: Buffer) => GetStudentByStudentIdRequest.decode(value),
    responseSerialize: (value: GetStudentByStudentIdResponse) =>
      Buffer.from(GetStudentByStudentIdResponse.encode(value).finish()),
    responseDeserialize: (value: Buffer) => GetStudentByStudentIdResponse.decode(value),
  },
  /**
  ...
  editStudent: {
    ...
    requestStream: false,
    responseStream: false,
    requestSerialize: (value: EditStudentRequest) => Buffer.from(EditStudentRequest.encode(value).finish()),
    requestDeserialize: (value: Buffer) => EditStudentRequest.decode(value),
    responseSerialize: (value: EditStudentResponse) => Buffer.from(EditStudentResponse.encode(value).finish()),
  ...
  listStudentMapping: {
    ...
    requestDeserialize: (value: Buffer) => ListStudentMappingRequest.decode(value),
    responseSerialize: (value: ListStudentMappingResponse) =>
      Buffer.from(ListStudentMappingResponse.encode(value).finish()),
    responseDeserialize: (value: Buffer) => ListStudentMappingResponse.decode(value),
  },
} as const;

export interface StudentServiceServer extends UntypedServiceImplementation {
  getStudentById: handleUnaryCall<GetStudentByIdRequest, GetStudentByIdResponse>;
  getStudentByStudentId: handleUnaryCall<GetStudentByStudentIdRequest, GetStudentByStudentIdResponse>;
  /**
   * Edit student information.
   *
   * The system look for `student.id` for target student to edit.
   ...
   * Use to get data available about normalized type such as religion.
   */
  listStudentMapping: handleUnaryCall<ListStudentMappingRequest, ListStudentMappingResponse>;
}

export interface StudentServiceClient extends Client {
  getStudentById(
    request: GetStudentByIdRequest,
    callback: (error: ServiceError | null, response: GetStudentByIdResponse) => void,
  ): ClientUnaryCall;
  getStudentById(
    request: GetStudentByIdRequest,
    metadata: Metadata,
  ...
  getStudentByStudentId(
    ...
    callback: (error: ServiceError | null, response: GetStudentByStudentIdResponse) => void,
  ): ClientUnaryCall;
  getStudentByStudentId(
    request: GetStudentByStudentIdRequest,
    metadata: Metadata,
  ...
  editStudent(
    ...
    callback: (error: ServiceError | null, response: EditStudentResponse) => void,
  ): ClientUnaryCall;
  editStudent(
    request: EditStudentRequest,
    metadata: Metadata,
  ...
  listStudentMapping(
    ...
    callback: (error: ServiceError | null, response: ListStudentMappingResponse) => void,
  ): ClientUnaryCall;
  listStudentMapping(
    request: ListStudentMappingRequest,
    metadata: Metadata,
...
export const StudentServiceClient = makeGenericClientConstructor(
  ...
  new (address: string, credentials: ChannelCredentials, options?: Partial<ClientOptions>): StudentServiceClient;
