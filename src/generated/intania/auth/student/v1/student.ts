...
export const GetStudentByStudentIdRequest: MessageFns<GetStudentByStudentIdRequest> =
    {
        ...
        create<I extends Exact<DeepPartial<GetStudentByStudentIdRequest>, I>>(
            ...
            return GetStudentByStudentIdRequest.fromPartial(
                base ?? ({} as any),
            );
        },
        fromPartial<
            I extends Exact<DeepPartial<GetStudentByStudentIdRequest>, I>,
        >(object: I): GetStudentByStudentIdRequest {
            const message = createBaseGetStudentByStudentIdRequest();
...
export const GetStudentByStudentIdResponse: MessageFns<GetStudentByStudentIdResponse> =
    {
            ...
            while (reader.pos < end) {
                ...
                switch (tag >>> 3) {
                    case 1: {
                        ...
                        message.student = Student.decode(
                            reader,
                            reader.uint32(),
                        );
                        continue;
        ...
        create<I extends Exact<DeepPartial<GetStudentByStudentIdResponse>, I>>(
            ...
            return GetStudentByStudentIdResponse.fromPartial(
                base ?? ({} as any),
            );
        },
        fromPartial<
            I extends Exact<DeepPartial<GetStudentByStudentIdResponse>, I>,
        >(object: I): GetStudentByStudentIdResponse {
            const message = createBaseGetStudentByStudentIdResponse();
            message.student =
                object.student !== undefined && object.student !== null
                    ? Student.fromPartial(object.student)
...
export const ListStudentMappingResponse: MessageFns<ListStudentMappingResponse> =
    {
            ...
            while (reader.pos < end) {
                ...
                switch (tag >>> 3) {
                    ...
                    case 2: {
                        ...
                        message.religions.push(
                            Religion.decode(reader, reader.uint32()),
                        );
                        continue;
                    }
                    case 3: {
                    ...
                    case 6: {
                        ...
                        message.provinces.push(
                            Province.decode(reader, reader.uint32()),
                        );
                        continue;
                    }
                    case 7: {
                        ...
                        message.districts.push(
                            District.decode(reader, reader.uint32()),
                        );
                        continue;
                    }
                }
        ...
        fromJSON(object: any): ListStudentMappingResponse {
            return {
                ...
                familyStatuses: globalThis.Array.isArray(object?.familyStatuses)
                    ? object.familyStatuses.map((e: any) =>
                          FamilyStatus.fromJSON(e),
                      )
                    : [],
        ...
        toJSON(message: ListStudentMappingResponse): unknown {
            ...
            if (message.departments?.length) {
                obj.departments = message.departments.map((e) =>
                    Department.toJSON(e),
                );
            }
            if (message.religions?.length) {
                obj.religions = message.religions.map((e) =>
                    Religion.toJSON(e),
                );
            }
            ...
            if (message.familyMemberStatuses?.length) {
                obj.familyMemberStatuses = message.familyMemberStatuses.map(
                    (e) => FamilyMemberStatus.toJSON(e),
                );
            }
            ...
            if (message.districts?.length) {
                obj.districts = message.districts.map((e) =>
                    District.toJSON(e),
                );
            }
            return obj;
        ...
        fromPartial<
            I extends Exact<DeepPartial<ListStudentMappingResponse>, I>,
        >(object: I): ListStudentMappingResponse {
            const message = createBaseListStudentMappingResponse();
            message.departments =
            ...
            message.familyStatuses =
                object.familyStatuses?.map((e) =>
                    FamilyStatus.fromPartial(e),
                ) || [];
        ...
        while (reader.pos < end) {
            ...
            switch (tag >>> 3) {
                ...
                case 6: {
                    ...
                    message.department = Department.decode(
                        reader,
                        reader.uint32(),
                    );
                    continue;
                ...
                case 19: {
                    ...
                    message.nationality = Country.decode(
                        reader,
                        reader.uint32(),
                    );
                    continue;
                ...
                case 35: {
                    ...
                    message.familyStatus = FamilyStatus.decode(
                        reader,
                        reader.uint32(),
                    );
                    continue;
    ...
    fromJSON(object: any): Student {
        return {
            ...
            email: isSet(object.email)
                ? globalThis.String(object.email)
                : undefined,
    ...
    fromPartial<I extends Exact<DeepPartial<Student>, I>>(object: I): Student {
        ...
        message.currentAddressDistrict =
            ...
            object.currentAddressDistrict !== null
                ...
                : undefined;
        message.currentAddressLatitude =
            object.currentAddressLatitude ?? undefined;
        ...
        message.hometownAddressNumber =
            object.hometownAddressNumber ?? undefined;
        message.hometownAddressProvince =
...
export const Religion: MessageFns<Religion> = {
    ...
    fromPartial<I extends Exact<DeepPartial<Religion>, I>>(
        object: I,
    ): Religion {
        const message = createBaseReligion();
        message.id = object.id ?? 0;
...
export const Province: MessageFns<Province> = {
    ...
    fromPartial<I extends Exact<DeepPartial<Province>, I>>(
        object: I,
    ): Province {
        const message = createBaseProvince();
        message.id = object.id ?? 0;
...
export const District: MessageFns<District> = {
    ...
    fromPartial<I extends Exact<DeepPartial<District>, I>>(
        object: I,
    ): District {
        const message = createBaseDistrict();
        message.id = object.id ?? 0;
...
export const StudentServiceService = {
    getStudentById: {
        ...
        requestDeserialize: (value: Buffer) =>
            GetStudentByIdRequest.decode(value),
    ...
    editStudent: {
        ...
        responseDeserialize: (value: Buffer) =>
            EditStudentResponse.decode(value),
    },
    /**
     * Get map data
