...
export const familyMemberStatuses = createTable(
...
export const familyStatuses = createTable(
  "family_statuses",
  {
    id: serial("id").primaryKey(),
    valueTh: varchar("value_th", { length: 30 }),
...
export const religions = createTable(
  "religions",
  {
    id: serial("id").primaryKey(),
...
export const thaiProvinces = createTable(
  "thai_provinces",
  {
    id: serial("id").primaryKey(),
...
export const thaiDistricts = createTable(
  "thai_districts",
  {
    id: serial("id").primaryKey(),
    provinceCode: smallint("province_code").references(() => thaiProvinces.provinceCode),
...
export const engineeringDepartments = createTable(
...
export const students = createTable(
  "students",
  {
    ...
    departmentId: integer("department_id").references(() => engineeringDepartments.id),
