...
CREATE TABLE IF NOT EXISTS "intania-oidc_students" (
	...
	"title_th" varchar(30),
	"title_en" varchar(30),
	"first_name_th" varchar(90),
	"first_name_en" varchar(90),
	"family_name_th" varchar(90),
	"family_name_en" varchar(90),
	"middle_name_th" varchar(90),
	"middle_name_en" varchar(90),
	"nickname_th" varchar(50),
	"nickname_en" varchar(50),
	"preferred_pronoun" varchar(50),
	"line_id" varchar(30),
	"facebook" varchar(60),
	"food_limitations" varchar(200),
	"drug_allergies" varchar(200),
